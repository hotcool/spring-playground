...
public class MathServiceTest {
    ...
    ClosedLineSegments closedLineSegments;

    @Before
    public void setup(){
        closedLineSegments = new ClosedLineSegments("circle", 8,0,0);
    }
    ...
    @Test
    public void testAreaInvalidName(){
